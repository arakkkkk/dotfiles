...
map("n", "<leader>hc", "<cmd>HopChar1<CR>", opts)
...
map("n", "<C-w>", "<cmd> lua vim.api.nvim_command('write')<CR>", opts)

-- ForceQuit
map("n", "<C-q>", "<cmd>q!<CR>", opts)

-- Mine
map("n", "<leader>v", ":! osascript -e 'tell application \"Vivaldi\" to reload active tab of window 1'<CR><CR>", opts)
